...
//                });
    ...
    @Test
    void testCreateNewEmployee_whenEmployeeAlreadyExsists_thenThrowException() {
        Employee savedEmployee = employeeRepository.save(testEmployee);
    ...
    @Test
    void testCreateNewEmployee_whenEmployeeIsNotExsists_thenCreateEmployee() {
        webTestClient.post()
                .uri("/employees")
                .bodyValue(testEmployeeDto)
                .exchange()
    ...
    @Test
    void testUpdateEmployee_whenEmployeeDoesNotExsists_thenThrowException() {
        webTestClient.put()
                .uri("/employees/999")
                .bodyValue(testEmployeeDto)
                .exchange()
    ...
    @Test
    void testUpdateEmployee_whenEmployeeIsValid_theUpdateEmployee() {
        Employee savedEmployee = employeeRepository.save(testEmployee);
    ...
    @Test
    void testDeleteEmployee_whenEmployeeDoesNotExsists_thenThrowException() {
    ...
    @Test
    void testDeleteEmployee_whenEmployeeExsists_thenDeleteEmployee() {
        Employee savedEmployee = employeeRepository.save(testEmployee);
    ...
    @Test
    void testDeleteEmployee_whenEmployeeExsists_thenDeleteEmployeeAndTryDeleteAgain() {
        Employee savedEmployee = employeeRepository.save(testEmployee);
